//
//  TransactionViewExtension.swift
//  RegisterApp
//
...
extension TransactionView {
    func setConstraintTableView() {
        ...
        NSLayoutConstraint.activate([
            ...
            trasactionsTableView.leftAnchor.constraint(equalTo: self.leftAnchor),
            trasactionsTableView.rightAnchor.constraint(equalTo: self.rightAnchor),
